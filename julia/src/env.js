...
export const env = createEnv({
	...
	server: {
		...
		JULIA_MAX_TOOL_TIMEOUT: z.string().optional(),
		JULIA_TOOL_OUTPUT_CHARS: z.string().optional(),
		JULIA_MAX_AGENT_TURNS: z.string().optional(),
		...
		OPENROUTER_DEEPSEEK_MODEL: z.string().default("deepseek/deepseek-v4-pro"),
	...
	runtimeEnv: {
		...
		JULIA_MAX_TOOL_TIMEOUT: process.env.JULIA_MAX_TOOL_TIMEOUT,
		JULIA_TOOL_OUTPUT_CHARS: process.env.JULIA_TOOL_OUTPUT_CHARS,
		JULIA_MAX_AGENT_TURNS: process.env.JULIA_MAX_AGENT_TURNS,
