...
CREATE TABLE "autopep_artifact" (
	...
	"source_url" text,
	"viewer_hint" text DEFAULT 'molstar' NOT NULL,
...
CREATE TABLE "autopep_protein_candidate" (
	...
	"ligand_ids_json" jsonb DEFAULT '[]'::jsonb NOT NULL,
	"citation_json" jsonb DEFAULT '{}'::jsonb NOT NULL,
...
ALTER TABLE "autopep_protein_candidate" ADD CONSTRAINT "autopep_protein_candidate_target_entity_id_autopep_target_entity_id_fk" FOREIGN KEY ("target_entity_id") REFERENCES "public"."autopep_target_entity"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "autopep_protein_candidate" ADD CONSTRAINT "autopep_protein_candidate_target_entity_run_fk" FOREIGN KEY ("target_entity_id","run_id") REFERENCES "public"."autopep_target_entity"("id","run_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
